...
abstract class ProductRepository {
  Future<Either<DatabaseFailure, ProductModel>> addProduct(ProductAddParam params);

  Future<Either<DatabaseFailure, List<ProductModel>>> getProducts(NoParams param);

  Future<Either<DatabaseFailure, ProductModel>> getProductById(int id);

  Future<Either<DatabaseFailure, ProductModel>> updateProduct(UpdateProductParam param);
